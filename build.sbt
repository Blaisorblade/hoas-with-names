...
libraryDependencies in macros += "org.scala-lang" % "scala-reflect" % scalaVersion.value
...
libraryDependencies in macros += compilerPlugin("org.scalamacros" % "paradise" % "2.0.0-M1" cross CrossVersion.full)
